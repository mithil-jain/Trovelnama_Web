...
<section id="Posts">
  ...
  <section class="bg-dark p-2" id="job_sequence">
    <div class="text-center job-title bg-light">
      <h5 class="py-1">Job Title</h5>
    </div>

    <div class="row text-center py-2">
      <div class="col-md-3">
        <div class="container border text-white py-2">
          <h6>Skills Required</h6><hr> Lorem ipsum dolor.
        </div>
      </div>
      <div class="col-md-3">
        <div class="container py-2 bg-light">
          <h6>Location</h6> <hr> Lorem ipsum dolor.
        </div>
      </div>
      <div class="col-md-3">
        <div class="container border text-white py-2">
          <h6>Duration</h6> <hr> Lorem ipsum dolor.
        </div>
      </div>
      <div class="col-md-3">
        <div class="container bg-light">
          <h6 class="pt-2">Stipped: Rs.XXX</h6> <hr> <div class="btn btn-dark btn-sm mb-1">Apply</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <!-- <div class="container outer-post">

    <div class="container main-post">
      <div class="container-header text-center py-1 text-white job-title">
        <h4>Job Title</h4>
      </div>
        <div class="row">
          <div class="col-md-3">
            <div class="container bg-dark mt-2 text-white py-2 text-center">
              Skills Required <hr> Lorem ipsum dolor.
            </div>
          </div>
          <div class="col-md-3">
            <div class="container bg-light mt-2 py-2 text-center">
              Location <hr> Lorem ipsum dolor.
            </div>
          </div>
          <div class="col-md-3">
            <div class="container bg-dark mt-2 text-white py-2 text-center">
              Duration <hr> Lorem ipsum dolor.
            </div>
          </div>
          <div class="col-md-3">
            <div class="container bg-light mt-2 py-2 text-center">
              Stipened: INR(approx) <hr> Lorem ipsum dolor.
            </div>
          </div>
        </div>
    </div>

    <div class="container main-post text-white">
      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Totam, facilis!
      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste, placeat quisquam quod similique beatae! Aperiam nemo cupiditate debitis quis ex eos molestiae deleniti vel saepe, blanditiis atque fuga earum quam accusamus error officia nulla excepturi quaerat, porro exercitationem at reiciendis dignissimos! Expedita, hic. Vitae fugiat fugit iste excepturi nam! Laborum?
    </div>
